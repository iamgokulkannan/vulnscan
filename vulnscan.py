...
def csrf(domain_name):
    ...
    if allTokens:
        aToken = allTokens[0]
        # Continue with the rest of the code that uses aToken
    else:
    ...
    try:
        ...
        print('%s No CSRF protection to test , CSRF vulnerability not found' % bad)
        return
...
if __name__ == "__main__":
    while True:
        ...
        while True:
            ...
            print("9. Exit\n")
            choice = input(
                "Enter a choice from the given options (1, 2, 3, 4, 5, 6, 7 , 8 or 9): ")
            ...
            if choice == '1':
                ...
                print(
                    "\nInvalid option. Please enter a valid option (1, 2, 3, 4, 5, 6, 7 , 8 or 9)")
